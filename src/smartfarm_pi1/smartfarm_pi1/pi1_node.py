...
CAM_INDEX = (
    '/dev/v4l/by-path/'
    'platform-xhci-hcd.0-usb-0:1:1.0-video-index0'
)

# 발아실 왼쪽 카메라
NURSERY_LEFT_CAM_INDEX = (
    '/dev/v4l/by-path/'
    'platform-xhci-hcd.0-usb-0:2:1.0-video-index0'
)

# 발아실 오른쪽 카메라
NURSERY_RIGHT_CAM_INDEX = (
    '/dev/v4l/by-path/'
    'platform-xhci-hcd.1-usb-0:1:1.0-video-index0'
)
